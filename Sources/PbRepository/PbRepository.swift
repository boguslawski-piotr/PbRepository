...
public protocol PbRepository: PbSimpleRepository {
    ...
    func metadata(forAllMatching isIncluded: (String) throws -> Bool) throws -> ThrowingStream<
        ItemMetadata, Error
    >
    ...
    func retrieve<T: Decodable>(sequenceOf type: T.Type, from name: String) throws -> ThrowingStream<
        T, Error
    >?
}
...
public protocol PbRepositoryAsync: PbSimpleRepositoryAsync {
    ...
    func metadataAsync(forAllMatching isIncluded: (String) throws -> Bool) async throws
        -> AsyncThrowingStream<ItemMetadata, Error>
    ...
    func retrieveAsync<T: Decodable>(sequenceOf type: T.Type, from name: String) async throws
